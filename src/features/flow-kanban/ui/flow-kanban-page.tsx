...
export function FlowKanbanPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-100 text-slate-950 transition-colors dark:bg-slate-950 dark:text-slate-50">
          ...
          <div className="space-y-4">
            <section className="rounded-md border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
              <div className="mb-3 flex items-center justify-between gap-3">
                <div className="text-left">
                  <h2 className="m-0 text-base font-semibold text-slate-950 dark:text-slate-50">工程フロー</h2>
                  <p className="text-sm text-slate-500 dark:text-slate-400">分岐・合流を持つDAGとして管理します。</p>
                </div>
              </div>
            ...
            <section className="rounded-md border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
              <div className="mb-3 text-left">
                <h2 className="m-0 text-base font-semibold text-slate-950 dark:text-slate-50">カンバン</h2>
